...
class AzureDevOpsAccountManager : PersistentStateComponent<AzureDevOpsAccountManager.State> {
    ...
    fun updateToken(
        ...
        if (account != null) {
            ...
            azuredevops.services.GitTokenManager
                .getInstance()
    ...
    private fun updateTokenInOpenProjects(
        ...
        try {
            ...
            for (project in openProjects) {
                try {
                    val detector =
                        azuredevops.services.AzureDevOpsRepositoryDetector
                            .getInstance(project)
                    ...
                    val gitService =
                        azuredevops.services.GitRepositoryService
                            .getInstance(project)
